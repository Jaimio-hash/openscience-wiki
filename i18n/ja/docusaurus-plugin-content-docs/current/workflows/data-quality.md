...
9 月 16 は、独立チェックベースラインに対してすべての **48** メトリックに一致しました。 その入力 SHA-256 は `128d2411f3169de0cac9963c30152bb5c9a3083ac80fd25651b97cf4b7304691` を残しました。 報告書は、Python 3.12.14とMetplotlib 3.11.1を記録します。 これらのチェックは、この計算の合意と入力保存を確立します。 レビュアー監査または独立した再生のための正確な環境を確立しません。

<a href="/docs/examples/gse60450/rerun-20260916/rnaseq-sample-qc.csv" download>QCのテーブル</a>、<a href="/docs/examples/gse60450/rerun-20260916/rnaseq-library-sizes.png" download>プロット</a>、<a href="/docs/examples/gse60450/rerun-20260916/rnaseq-qc-report.md" download>レポート</a>のリランをダウンロードしてください。 元の入力とセッションNotebookも保持します。 [例-データページ](../reference/example-data.md#saved-example-outputs)は、以前のベースラインとNotebookエクスポートを別々に保ちます。 これらのエクスポートは、この再実行からNotebookではありません。 [再現性チェック](../guides/reproducibility.md)は、別の環境と再実行評価のために使用します。
