...
![Die beigefügte Leitfähigkeitstabelle mit Werten, Einheiten und Quellzeilen](/img/open-science/research-workflows/conductivity-input.png)
...
![Die tatsächliche Notebook-Ausführung meldet die Eingabeprüfungen und macht den Plot](/img/open-science/research-workflows/conductivity-notebook.png)
...
![Aktuelle Open-Science-Vorschau des Leitfähigkeitsdiagramms und gemeldete SD-Fehlerbalken](/img/open-science/research-workflows/conductivity-figure.png)
...
![Die vier gespeicherten Ausgänge und die wieder geöffneten Methoden beachten](/img/open-science/research-workflows/conductivity-methods.png)
