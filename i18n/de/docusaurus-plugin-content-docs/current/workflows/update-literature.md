...
![Gespeicherte Baseline-Suchspezifikation und gespeicherte Datensätze](/img/open-science/workflow-extensions/freshwater-search-plan.png)
...
![Baseline-Importvorschau für die benannte Kollektion](/img/open-science/workflow-extensions/freshwater-import-baseline.png)
...
![Die Sieben-Referenz-Baseline-Sammlung](/img/open-science/workflow-extensions/freshwater-collection-baseline.png)
...
![Gespeichertes Update-Audit mit Ergänzungen und Ausschlüssen](/img/open-science/workflow-extensions/freshwater-update-audit.png)
...
![Die Update-Importvorschau zeigt sieben Additionen](/img/open-science/workflow-extensions/freshwater-import-update.png)
...
![Die aktualisierte Sammlung mit vierzehn Referenzen](/img/open-science/workflow-extensions/freshwater-collection-updated.png)
