...
| Kontrolle | Wirkung |
| --- | --- |
| Voller Zugriff On | Verwendet Main Agents Skills und Connectors, einschließlich späterer Ergänzungen. |
...
| Service/Runtime | Verbundener Server, erforderliche Anmeldeinformationen, verfügbarer Kernel/Abhängigkeiten | Fehlende OpenAlex Schlüssel oder Paket. |
