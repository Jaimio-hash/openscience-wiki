...
![Прикрепленный вход CSV и его исходные колонки](/img/open-science/research-workflows/job-training-input.webp)
...
![Зарегистрированный выход Notebook содержит фактические проверки выборки и оценки регрессии.](/img/open-science/research-workflows/job-training-notebook.webp)
...
![Сохраненный регрессионный отчет на английском языке с выборочными проверками и оценками](/img/open-science/research-workflows/job-training-report.webp)
...
![Повторно открытый коэффициент CSV как с моделями, так и с последовательными блоками](/img/open-science/research-workflows/job-training-coefficients.webp)
