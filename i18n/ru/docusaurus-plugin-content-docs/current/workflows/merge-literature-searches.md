...
![Сохраненный союз обеих поисковых партий, сохраняющий членство в источнике](/img/open-science/workflow-extensions/batches-merged.png)
...
![Превью импорта первой партии: восемь новых ссылок в выбранной коллекции](/img/open-science/workflow-extensions/batches-import-a.png)
...
![Вторая партия предварительного просмотра идентифицирует общий документ как существующий.](/img/open-science/workflow-extensions/batches-import-b.png)
...
![Завершен второй импорт с семью созданными и одним повторно используемым](/img/open-science/workflow-extensions/batches-import-result.png)
...
![Заключительный сборник с пятнадцати ссылками](/img/open-science/workflow-extensions/batches-collection.png)
