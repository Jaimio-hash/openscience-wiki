...
![Фактическая прикрепленная матрица и ее колоночные определения](/img/open-science/research-workflows/rnaseq-qc-input.png)
...
![Успешный выход Notebook с размерами, хэшами и расчетными показателями выборки](/img/open-science/research-workflows/rnaseq-qc-rerun-notebook.png)
...
![Открытый двенадцатирядный столик из завершённого повтора](/img/open-science/research-workflows/rnaseq-qc-rerun-table.png)
...
Загрузите этот повтор <a href="/docs/examples/gse60450/rerun-20260916/rnaseq-sample-qc.csv" download>Таблица QC</a>, <a href="/docs/examples/gse60450/rerun-20260916/rnaseq-library-sizes.png" download>сюжет</a> и <a href="/docs/examples/gse60450/rerun-20260916/rnaseq-qc-report.md" download>доклад</a>. Сохраняйте исходный ввод и сеанс Notebook. [страница с примерными данными](../reference/example-data.md#saved-example-outputs) сохраняет более ранний базовый уровень и экспорт Notebook отдельно. Этот экспорт не является Notebook от этого повтора. Используйте [Проверка воспроизводимости](../guides/reproducibility.md) для отдельной оценки среды и повтора.
