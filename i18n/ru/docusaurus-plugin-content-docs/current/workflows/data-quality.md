...
![Открытый двенадцатирядный столик из завершённого повтора](/img/open-science/research-workflows/rnaseq-qc-rerun-table.webp)
...
![Сохраненный сырой библиотечный сюжет из того же повтора](/img/open-science/research-workflows/rnaseq-qc-rerun-plot.webp)
