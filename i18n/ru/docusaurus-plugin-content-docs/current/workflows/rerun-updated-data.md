...
![Запрос на вложение в течение первой недели и базовый расчет](/img/open-science/workflow-extensions/air-input-v1.png)
...
![Сэкономленные семидневные исходные и валидные часы](/img/open-science/workflow-extensions/air-baseline-table.png)
...
![Файл второй недели добавлен в существующий аналитический разговор.](/img/open-science/workflow-extensions/air-update-input.png)
...
![Расширенный четырнадцатидневный результат отображается в Open-Science](/img/open-science/workflow-extensions/air-update-plot.png)
...
![Сохраненное порядковое сравнение с неизмененными исходными датами](/img/open-science/workflow-extensions/air-update-check.png)
...
![В примечаниях к обновлению записывается неизмененный код, сохраняются исходные файлы и проверки данных](/img/open-science/workflow-extensions/air-update-notes.png)
...
![Исправленный отчет теперь называет полный двухнедельный интервал.](/img/open-science/workflow-extensions/air-reviewed-report.png)
