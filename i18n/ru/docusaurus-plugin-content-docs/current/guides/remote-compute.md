...
![Английская конфигурация SSH переопределяется](/img/open-science/walkthrough-2026-09-08/53-ssh-advanced.png)

![Пароль аутентификации и Slurm выбран в реальном виде](/img/open-science/walkthrough-2026-09-08/52-ssh-password-slurm.png)
...
![Успешная аутентификация пароля и зонд ресурсов хоста](/img/open-science/remote-compute/03-host-probe.png)
...
![Завершена работа Direct SSH с идентификатором и каталогом работы](/img/open-science/remote-compute/05-direct-job-completed.png)

![Открыта удаленная таблица RNA-seq QC со всеми двенадцатью образцами](/img/open-science/remote-compute/06-remote-qc-table.png)
...
![Та же подготовительная работа восстановлена после перезапуска заявки](/img/open-science/remote-compute/07-job-recovered-after-restart.png)
...
![Отмена подтверждена для выбранной работы по подготовке](/img/open-science/remote-compute/09-job-cancelled.png)
...
![Slurm выбран явно в режиме выполнения хоста](/img/open-science/remote-compute/10-slurm-execution-mode.png)
...
![Приложение все еще ожидает статуса терминала для завершенной рабочей нагрузки Slurm](/img/open-science/remote-compute/11-slurm-accounting-unavailable.png)
