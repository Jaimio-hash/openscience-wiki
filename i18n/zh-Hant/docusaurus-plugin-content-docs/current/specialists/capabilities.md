...
![明確分配能力的 Specialist](/img/open-science/capabilities-walkthrough/05-specialist-capabilities.jpg)

| 控制元件 | 作用 |
| --- | --- |
| Full access 開啟 | 使用 Main Agent 的 Skills/Connectors，包括以後新增的資源 |
...
| 服務/環境 | 連線、憑據、核心及依賴 | 缺少 OpenAlex 金鑰或包 |
