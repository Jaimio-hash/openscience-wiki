...
| Skill | 輸入 | 依賴與執行條件 | 應檢查的輸出 |
| --- | --- | --- | --- |
| [Literature Review](https://github.com/aipoch/open-science/blob/v0.26.0/resources/skills/literature-review/SKILL.md) · `literature-review` | 問題、文獻 ID 或論文 | 來源檢索；OpenAlex 操作需要其金鑰 | 可追溯的證據綜合與引用 |
