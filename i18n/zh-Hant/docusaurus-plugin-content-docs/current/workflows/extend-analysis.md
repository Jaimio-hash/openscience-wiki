...
下載 <ExampleDownload path="/examples/theoph/nca-conventions.md">官方 Skill 的 NCA 方法參考</ExampleDownload>，透過 **+ → Attach files** 新增到會話。這是安裝包中的未修改原檔案。本次配置下，Notebook 能讀取會話附件，但無法直接讀取 Skill 安裝目錄內的這份參考檔案。
