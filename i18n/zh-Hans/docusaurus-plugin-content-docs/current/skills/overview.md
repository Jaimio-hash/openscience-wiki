...
![搜索已保存的 RNA-seq Skill](/img/open-science/capabilities-walkthrough/02-skill-search.jpg)
...
![Customize 固定启用及原因提示](/img/open-science/v0.27.0/08-always-enabled-skill.png)
