...
![실제 첨부된 풀 텍스트 팩은 소스 정체성 및 문서 섹션을 유지합니다.](/img/open-science/research-workflows/mask-trials-input.png)
...
![Open-Science의 10 대 증거 테이블](/img/open-science/research-workflows/mask-trials-evidence.png)
...
![저장된 판독 노트와 완료된 10 줄 출력](/img/open-science/research-workflows/mask-trials-notes.png)
