...
![El Specialist con una selección explícita de la capacidad](/img/open-science/capabilities-walkthrough/05-specialist-capabilities.jpg)

| Control | Efecto |
| --- | --- |
| Acceso completo en | Utiliza Main Agent's Skills y Connectors, incluyendo adiciones posteriores. |
...
| Servicio/tiempo de funcionamiento | Servidor conectado, credenciales requeridas, kernel/dependencias disponibles | Faltando llave OpenAlex o paquete. |
