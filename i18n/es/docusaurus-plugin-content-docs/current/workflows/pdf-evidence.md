...
![Tanto el artículo como el suplemento se adjuntan a la solicitud real de comprobación de pruebas](/img/open-science/research-workflows/catalyst-two-inputs.webp)
...
![Figura 6 del artículo original y condiciones experimentales en Open-Science](/img/open-science/research-workflows/catalyst-figure6-source.webp)
...
![Figura suplementaria 51 en la página PDF real 47 de 52](/img/open-science/research-workflows/catalyst-supplement-47.webp)
...
![Informe de reclamación, pruebas, condiciones y límites salvados](/img/open-science/research-workflows/catalyst-claim-report.webp)
