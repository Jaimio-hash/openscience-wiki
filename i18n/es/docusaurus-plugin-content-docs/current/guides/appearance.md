...
| Leer cambios de versión o obtener ayuda | **About → Release notes / Help Center** abre la página externa correspondiente. Este wiki también tiene un [Cambio](../changelog/v0.30.1.md). |
