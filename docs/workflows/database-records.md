...
![The compound scope and requested files in the actual conversation](/img/open-science/workflow-extensions/pubchem-input.png)
...
![The actual query activity and saved-file readback in Notebook](/img/open-science/workflow-extensions/pubchem-lookup.png)
...
![The reopened seven-compound CSV](/img/open-science/workflow-extensions/pubchem-table.png)
...
![The saved procedure, validation results and interpretation limits](/img/open-science/workflow-extensions/pubchem-notes.png)
